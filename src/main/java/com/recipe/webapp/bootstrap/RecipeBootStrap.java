package com.recipe.webapp.bootstrap;

import com.recipe.webapp.domain.*;
import com.recipe.webapp.repositories.CategoryRepository;
import com.recipe.webapp.repositories.RecipeRepository;
import com.recipe.webapp.repositories.UnitOfMeasurementRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootStrap(RecipeRepository recipeRepository, CategoryRepository categoryRepository, UnitOfMeasurementRepository unitOfMeasurementRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasurementRepository.findByDescription("Cup");
